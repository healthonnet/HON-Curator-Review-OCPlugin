<?php return [
    ...
    'platform' => [
        ...
        'all' => 'All',
        'android' => 'Android',
        'android_version' => 'Android version for',
        'ios' => 'iOS',
        'ios_version' => 'iOS version for',
        'website' => 'Website',
        'website_version' => 'website version for',
        'name' => 'Platforms',
        'add_new' => 'Add a new platform for',
        'create' => 'Create',
        'sure' => 'are you sure ?',
        'search' => 'Search websites or Apps to review',
        'plat_name' => 'Name',
        'plat_description' => 'Description',
        'plat_link' => 'Link',
        'see_details' => 'See details',
        'review_this' => 'Review this Website/App',
    ...
    'search' => [
        ...
        'labels' => 'Labels',
        'results' => 'results',
        'fieldsearch' => 'Search website or App...',
    ],
    'service' => [
        'detail' => 'Description',
        ...
        'add_valid_title' => 'Website or Application Name. i.e. Health Curator',
        'create' => 'Create',
    ...
    'userservices' => [
        'myappsandwebsites' => 'My apps and websites',
        'appsandwebsitesmanagedby' => 'Apps and websites managed by ',
    ]
];